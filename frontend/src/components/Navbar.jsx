        ...
        <div className="container mx-auto px-6 py-3"> {/* Slightly reduced py for sleeker look */}
          <div className="flex justify-between items-center relative">
            ...
            <div className="flex items-center space-x-4 z-10">
              {user ? (
                <>
                  <span className="hidden sm:inline-flex items-center bg-gradient-to-r from-yellow-400 to-orange-400 text-white px-4 py-1.5 rounded-full text-sm font-bold shadow-md cursor-default">
                    ⭐ {user.karmaPoints || 0}
                  </span>
